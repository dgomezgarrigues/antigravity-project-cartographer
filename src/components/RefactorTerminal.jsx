...
=======
            <div className="flex items-center gap-2 px-4 py-2 bg-gray-900 border-b border-gray-800">
                <Terminal size={14} className={isDanger ? "text-red-500" : "text-green-500"} />
                <span className="text-xs font-semibold text-gray-300 tracking-wider">REFACTOR SANDBOX</span>
            </div>
>>>>>>> main
